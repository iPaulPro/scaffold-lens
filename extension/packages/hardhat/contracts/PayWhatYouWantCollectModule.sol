...
import {ICollectModule} from "./lens/modules/interfaces/ICollectModule.sol";
import {BaseFeeCollectModule} from "./lens/modules/act/collect/base/BaseFeeCollectModule.sol";
import {BaseFeeCollectModuleInitData, BaseProfilePublicationData} from "./lens/modules/interfaces/IBaseFeeCollectModule.sol";
import {ModuleTypes} from "./lens/modules/libraries/constants/ModuleTypes.sol";
...
/**
 * @title PayWhatYouWantCollectModule
 * @dev Collect Module for collecting Lens publications with any denomination of any token.
 * @dev Not a standalone Open Action; a Collect Module that can be use with CollectPublicationAction.
 * @author Paul Burke
 */
